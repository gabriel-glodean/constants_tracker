...
/**
 * Store interface for managing {@link UnitConstants} in a project context.
 *
 ...
 * }</pre>
 */
public interface UnitConstantsStore {

  /**
   * Stores the given {@link UnitConstants} for a specific project and version.
   *
   * @param constants the unit constants to store
   * @param project the project identifier
   * @param version the version number
   * @return a {@link Mono} emitting the stored {@link UnitConstants}
   */
  Mono<UnitConstants> store(UnitConstants constants, String project, int version);

  /**
   * Stores the given {@link UnitConstants} for a specific project.
   *
   * @param constants the unit constants to store
   * @param project the project identifier
   * @return a {@link Mono} emitting the stored {@link UnitConstants}
