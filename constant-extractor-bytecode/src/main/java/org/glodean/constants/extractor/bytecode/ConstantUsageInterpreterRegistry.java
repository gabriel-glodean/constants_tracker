...
public class ConstantUsageInterpreterRegistry {
    ...
    private final Multimap<UnitConstant.UsageType, ConstantUsageInterpreter> interpreters;

    private ConstantUsageInterpreterRegistry(Multimap<UnitConstant.UsageType, ConstantUsageInterpreter> interpreters) {
     ...
     * {@link UnitConstant.UsageType}. Multiple interpreters may be registered for the
    ...
    public static final class Builder {
         ...
         */
        public Builder register(UnitConstant.UsageType usageType, ConstantUsageInterpreter interpreter) {
            Objects.requireNonNull(usageType, "Usage type cannot be null");
     ...
     */
        ...
        STATIC_FIELD_STORE_INTERPRETER(UnitConstant.UsageType.STATIC_FIELD_STORE),

        FIELD_STORE_INTERPRETER(UnitConstant.UsageType.FIELD_STORE),
        ...
        private final static Map<UnitConstant.UsageType, NoOpConstantUsageInterpreter> TYPE_TO_INTERPRETER = Map.of(
                UnitConstant.UsageType.ARITHMETIC_OPERAND, ARITHMETIC_OPERAND_INTERPRETER,
                UnitConstant.UsageType.STRING_CONCATENATION_MEMBER, STRING_CONCATENATION_MEMBER_INTERPRETER,
                UnitConstant.UsageType.STATIC_FIELD_STORE, STATIC_FIELD_STORE_INTERPRETER,
                UnitConstant.UsageType.FIELD_STORE, FIELD_STORE_INTERPRETER,
                UnitConstant.UsageType.METHOD_INVOCATION_TARGET, METHOD_INVOCATION_TARGET_INTERPRETER,
                UnitConstant.UsageType.METHOD_INVOCATION_PARAMETER, METHOD_INVOCATION_PARAMETER_INTERPRETER,
                UnitConstant.UsageType.ANNOTATION_VALUE, ANNOTATION_VALUE_INTERPRETER
        );

        static NoOpConstantUsageInterpreter forType(UnitConstant.UsageType usageType) {
         ...
         * @return a minimal {@link UnitConstant.ConstantUsage} record with UNKNOWN semantic type
         */
        @Override
         ...
         */
        @Override
        public boolean canInterpret(UnitConstant.UsageType type) {
