...
class PointsToJVMTest {
    ...
    static class ClassMethodNameProvider implements ArgumentsProvider {
        ...
        public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) {
            return Stream.of(
                    ...
                    Arguments.of(ArrayFunctionality.class, "writeToIndex", """
                                    8: IASTORE                      \s
                            ...
                            , false),
                    Arguments.of(ArrayFunctionality.class, "readIndex", """
                             6: IALOAD                       \s
                            ...
                            """, false),
                    Arguments.of(FieldFunctionality.class, "<clinit>", """
                             2: PUTSTATIC                    \s
                            ...
                            """, false),
                    Arguments.of(FieldFunctionality.class, "<init>", """
                            8: PUTFIELD                     \s
                            ...
                            """, false),
                    Arguments.of(FieldFunctionality.class, "getStaticField", """
                            1: GETSTATIC                    \s
                            ...
                            """, false),
                    Arguments.of(FieldFunctionality.class, "getField", """
                             4: GETFIELD                     \s
                            ...
                            """, false),
                    Arguments.of(TypeCheckingFunctionality.class, "isString", """
                             5: INSTANCEOF                   \s
                            ...
                            """, false),
                    Arguments.of(TypeCheckingFunctionality.class, "stringLength", """
                             5: CHECKCAST                    \s
                                 IN  Locals: 0=Lorg/glodean/constants/samples/TypeCheckingFunctionality;@org/glodean/constants/samples/TypeCheckingFunctionality::<this> 1=Ljava/lang/Object;@Param#1 | Stack: [Ljava/lang/Object;@Param#1] | Heap: | Statics: | Arrays:
                            """, false)
            );
    ...
    public void run(Class<?> clazz, String methodName, String expectedString, boolean log) throws IOException {
