...
public final class State {
    ...
    public State copy() {
        ...
        for (int i = 0; i < stack.size(); i++) s.stack.add(stack.get(i) == null ? null : stack.get(i).copy());
...
// Heap-like maps
    ...
    public boolean equals(Object o) {
        ...
        State state = (State) o;
        return Objects.equals(locals, state.locals) && Objects.equals(stack, state.stack) && Objects.equals(heap, state.heap) && Objects.equals(statics, state.statics) && Objects.equals(arrayElements, state.arrayElements);
    }
