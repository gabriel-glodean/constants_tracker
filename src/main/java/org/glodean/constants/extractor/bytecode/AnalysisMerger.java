...
enum AnalysisMerger {
    ...
    public Multimap<Object, ClassConstant.UsageType> merge(List<CodeElement> code, final List<State> in) {
    ...
    private static void handle(CodeElement instr, State state, Multimap<Object, ClassConstant.UsageType> map) {
        if (instr == null) {
            return;
        }
        switch (instr) {
    ...
    private static void handle(PointsToSet stackAndParameterEntities, Multimap<Object, ClassConstant.UsageType> map, ClassConstant.UsageType usageType) {
